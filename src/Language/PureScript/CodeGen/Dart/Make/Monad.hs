...
module Language.PureScript.CodeGen.Dart.Make.Monad
...
import           Language.PureScript.CodeGen.Dart.Options

-- | A monad for running make actions
--  NOTE: This is specialized to the backend because the `Options` field depends on JS-related options
newtype Make a = Make
  { unMake :: ReaderT Options (ExceptT MultipleErrors (Logger MultipleErrors)) a
  } deriving newtype (Functor, Applicative, Monad, MonadIO, MonadError MultipleErrors, MonadWriter MultipleErrors, MonadReader Options)
